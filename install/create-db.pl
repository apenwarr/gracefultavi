...
@otb = (
    ...
    "INSERT INTO `" . $prefix . "pages` VALUES (7,'JumpSearch','JumpSearch',1,1,'JMPSRX',1160,1,NULL,NULL,'');",
    ...
    "INSERT INTO `" . $prefix . "pages` VALUES (11,'TextFormattingRules','TextFormattingRules',1,1,'TKSTFRMTNKRLS',14629,1,NULL,NULL,'');",
    ...
    "INSERT INTO `" . $prefix . "links` VALUES ('JumpSearch','JumpSearch',1);",
